CREATE DATABASE MAKWENG_RESIDENTS_LIBRARY;
USE MAKWENG_RESIDENTS_LIBRARY;
...
INSERT INTO BOOKS (ISBN, Title, Publisher, PublishedYear, NumberOfPages, BookLocation, Price, Subtitle,) 
VALUES 
(9780132350884, 'Clean Code', 'Prentice Hall', '2008-08-11', 464, 'Shelf A', 30, 'A Handbook of Agile Software Craftsmanship' , 16),
(9780201835953, 'Design Patterns', 'Addison-Wesley Professional', '1994-10-31', 416, 'Shelf B', 40, 'Elements of Reusable Object-Oriented Software', 12);